...
* **[Lab 05: Restricting Key Vault Public Perimeters and Implementing Multi-Layer Access Validation](./02-infrastructure-data-security/lab-05-key-vault-perimeter-hardening.md)** — Closing internet-facing exposure on an Azure Key Vault by restricting access to a specific trusted public IP and implementing modern Azure RBAC to separate vault management from secret visibility.
